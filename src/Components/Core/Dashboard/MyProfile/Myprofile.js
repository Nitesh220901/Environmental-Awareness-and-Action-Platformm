    ...
    <div className="w-full min-h-screen  pt-16 text-white">
      <div className="w-11/12  mx-auto ">
        ...
        <div className="w-full flex flex-col gap-10 pt-16 ">
          ...
          <div className="w-full  h-fit bg-richblack-800 flex justify-center rounded-lg border-[0.5px] border-richblack-500">
            <div className="w-11/12 relative h-fit gap-6 py-7 mx-auto flex flex-col  items-start">
